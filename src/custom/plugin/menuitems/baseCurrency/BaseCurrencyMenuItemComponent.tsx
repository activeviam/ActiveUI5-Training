...
export const BaseCurrencyMenuItemComponent:  FC<MenuItemProps<FxComponentWidgetState>> = (props) => {
    ...
    //TODO: Ex4 - reuse the query to get the currencies.
    ...
    // TODO: return a list of items corresponding to the currencies. When clicking on an item a new base currency should be selected
    return (
        <div>
